...
public class NotificationService {
    ...
    public void sendNotification(MQPayRequest tPayRequest)  {
        ...
        try {
            ...
            log.error("Cannot send notify for payRequest.order = {}, username = {}", tPayRequest.getOrderId(), tPayRequest.getClientId(), e);
            log.error("Error: ", e);
