...
public class ConfirmListener {
    ...
    @RabbitListener(queues = "${application.rabbitmq.confirmreq.storeQueueName}")
    public void receiveMessage(String requestAsString) {
        ...
        try {
            ...
            /* Обработать запрос */
            orderConfirmRequest = confirmService.process(orderConfirmRequest);
            ...
            MQOrderConfirmResponse response
                    ...
                    .setReferenceId(orderConfirmRequest.getId().toString());
